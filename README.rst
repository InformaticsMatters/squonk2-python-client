...
- ``DmApi.get_dataset_metadata()``
- ``DmApi.get_dataset_schema()``
- ``DmApi.get_dataset_version_metadata()``
- ``DmApi.get_dataset_versions()``
- ``DmApi.get_job()``
- ``DmApi.get_job_definition_schema_version()``
- ``DmApi.get_job_exchange_rate()``
- ``DmApi.get_job_exchange_rates()``
- ``DmApi.get_job_manifests()``
- ``DmApi.get_job_by_version()``
- ``DmApi.get_input_handler()``
- ``DmApi.get_instance()``
- ``DmApi.get_mode()``
- ``DmApi.get_project()``
- ``DmApi.get_project_file()``
...
- ``DmApi.load_job_manifests()``
- ``DmApi.move_project_file()``
- ``DmApi.move_project_path()``
- ``DmApi.put_unmanaged_project_files()``
- ``DmApi.put_job_manifest()``
- ``DmApi.remove_dataset_editor()``
- ``DmApi.remove_project_administrator()``
...
- ``DmApi.update_dataset_metadata()``
- ``DmApi.update_dataset_version_metadata()``
- ``DmApi.update_instance()``
- ``DmApi.update_project()``
- ``DmApi.update_user_account()``
- ``DmApi.update_workflow()``
- ``DmApi.upload_dataset()``
